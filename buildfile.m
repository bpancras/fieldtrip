...
files = ["det2x2.c", "det3x3.c", "ft_getopt.c", "ft_spike_sub_crossx.c", "getpid.c", "inv2x2.c", "inv3x3.c",...
  "meg_leadfield1.c", "mtimes2x2.c", "mtimes3x3.c", "mxDeserialize_c.c", "mxSerialize_c.c", "nanaccum.c", "nanmean.c",...
...
for f = files
plan("mex:"+f) = matlab.buildtool.tasks.MexTask(fullfile("src",files(1)), outputDir, Options=mexOptions);
end
